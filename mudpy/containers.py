...
class mhist(mcontainer):
    ...
    def ctypes(self, *args, **kwargs):        return self.data.ctypes
    ...
    def dtype(self, *args, **kwargs):         return self.data.dtype
    ...
    def flags(self, *args, **kwargs):         return self.data.flags
    def flat(self, *args, **kwargs):          return self.data.flat
    ...
    def imag(self, *args, **kwargs):          return self.data.imag
    ...
    def itemsize(self, *args, **kwargs):      return self.data.itemsize
    ...
    def nbytes(self, *args, **kwargs):        return self.data.nbytes
    def ndim(self, *args, **kwargs):          return self.data.ndim
    ...
    def real(self, *args, **kwargs):          return self.data.real
    ...
    def shape(self, *args, **kwargs):         return self.data.shape
    ...
    def strides(self, *args, **kwargs):       return self.data.strides
